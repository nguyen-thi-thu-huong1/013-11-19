@extends('layouts.agent_template')
...
<div class="card shadow mb-4">
    ...
    @if (Auth::user()->pay_password)
    <form class="user" action="{{url('/editPayPassword')}}" method="post" onsubmit="return checkForm(1);">
        @csrf
    ...
    @else 
    <form action="{{url('/editPayPassword')}}" method="post" onsubmit="return checkForm(2)">
        @csrf
        <div class="modal-body" style="padding-top:35px;">
            <div class="form-group row">
                <div class="col-sm-6a">
                ...
                <div class="col-sm-6b">
                    <input type="password" name="new_password" id="new_password" required class="form-control form-control-user" placeholder="请输入资金密码">
                </div>
            </div>
