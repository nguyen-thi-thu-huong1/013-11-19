    ...
    <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <p>代理链接：<font color="burlywood"><b>http://tg-demo.cc:82/register?i={{$user->id}}</b></font>
                </p>
                <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 10rem;" id="girlImg" src="img/ewm.jpg" alt="">
                    <button type="button" onclick="downloadImg()" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> 保存我的推广二维码</button>
